                    ...
                    <div class="col">
                        <div class="card radius-10 bg-info">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-dark"> Total User</p>
                                        <h4 class="my-1 text-dark">0</h4>
                                    </div>
                                    <div class="widgets-icons bg-white text-dark ms-auto"><i class="fa-solid fa-arrow-up-right-dots"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
