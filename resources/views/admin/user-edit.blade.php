...
<div class="page-wrapper">
   <div class="page-content">
      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
         ...
         <div class="ms-auto">
            <a href="{{url('user-list')}}" class="btn btn-danger"><i class='fa fa-eye'></i>View employees</a>
         </div>
      </div>
      <!--end breadcrumb-->
      @if(session('success'))
			...
			<div class="card border-top border-0 border-4 border-primary">
				<div class="card-body p-4">
					<div class="card-title d-flex align-items-center">
						...
						<hr>
						<form class="row g-3" method="post" action="{{url('update-user/'.$user->id)}}" enctype="multipart/form-data">
							@csrf
							<div class="col-md-6">
								<label for="" class="form-label">Name</label>
								<input type="text" name="name" value="{{$user->name}}" class="form-control" id="" autofocus>
                     ...
                     <div class="col-md-6">
								...
								<input type="text" name="phone_number" value="{{$user->phone_number}}" class="form-control" id="" >
                         <span style="color:red;">
                         @error('phone_number')
                         {{$message}}
                         @enderror
					...
					<div class="col-md-6">
						...
						<div class="input-group" id="show_hide_password">
													<input type="password" value="{{$user->user_key}}" class="form-control border-end-0" name="password" id="inputChoosePassword" value="" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
                         <span style="color:red;">
                         @error('password')
                         {{$message}}
