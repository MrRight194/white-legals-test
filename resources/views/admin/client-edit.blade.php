			...
			<div class="card border-top border-0 border-4 border-primary">
				<div class="card-body p-4">
					<div class="card-title d-flex align-items-center">
						...
						<hr>
						<form class="row g-3" method="post" action="{{url('update-client/'.$client->id)}}" enctype="multipart/form-data">
							@csrf
							<div class="col-md-6">
								<label for="" class="form-label">Name</label>
								<input type="text" name="name" value="{{$client->name}}" class="form-control" id="" autofocus>
                     ...
                     <div class="col-md-6">
								...
								<input type="text" name="email" value="{{$client->email}}" class="form-control" id="" >
                        <span style="color:red;">
                        @error('email')
                        {{$message}}
                        @enderror
                     ...
                     <div class="col-md-6">
								...
								<input type="text" name="address" value="{{$client->address}}" class="form-control" id="" >
                         <span style="color:red;">
                         @error('address')
                         {{$message}}
                         @enderror
					...
					<div class="col-md-6">
						...
						<input type="text" name="city" value="{{$client->city}}" class="form-control" id="" >
                         <span style="color:red;">
                         @error('city')
                         {{$message}}
                         @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="notes" id=""  class="form-control" cols="30" rows="10">{{$client->notes}}</textarea>
                         <span style="color:red;">
                         @error('notes')
                         {{$message}}
                         @enderror
